                ...
                <div class="scrollbar-sidebar bg-light sidebar-text-dark active">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="../controllers/Elections?polling_sheet=1" class="mm-active">
                                    <i class="metismenu-icon pe-7s-rocket"></i>
                                    Admin Dashboard
                                </a>
                            </li>
                            <li class="app-sidebar__heading">Collation Centre</li>
                            <li>
                                <a href="index.html#">
                                ...
                                <ul>
                                    <li>
                                        <a href="../pages/add_candidate.php">
                                    ...
                                    <li>
                                        <a href="../pages/election_results_summary.php">
                                            <i class="metismenu-icon">
                                            </i>Constituency Results
                                        </a>
                                    </li>
                                        
                                     <li>
                                        <a href="../pages/election_results_detail.php">
                                            <i class="metismenu-icon">
                                            </i>Polling Station results
                                        </a>
                                    </li>
                                    <li>
                                        <a href="polling_stations.php">
                                            <i class="metismenu-icon"></i>
                                            Polling Stations
                                        </a>
                                    </li>
                        ...
                        <div>
                            <br/>
                            <img src="../public/imgs/vote1.png" width="70px" height="80px" >
                        </div>
                    </div>
                </div>
            </div>    
